...
export default {
  data () {
    return {
      currentPageWeb: 1,
      pageSize: 48,
      filter_result: { category: '动漫', sort: '最热', type: '全部', region: '全部', year: '全部', postage: '全部', currentPage: 0, pageSize: 48 },
      ...
      video_filter: {
        ...
        type: ['全部', '经典', '科幻', '搞笑', '魔法', '惊悚', '真人', '动作', '原创', '校园', '剧情', '校园', '竞技', '儿童搞笑'],
        region: ['全部', '内地', '日本', '欧美', '其他'],
